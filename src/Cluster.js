  ...
  load() {
    ...
    while (this.dataInterface.offset < this.end) {
      ...
      case 0x1F43B675:
        ...
        // Next cluster - probably got an indeterminate size of cluster, so
        // force our end condition
        this.dataInterface.returnElement(this.tempElementHeader);
        this.end = this.dataInterface.offset;
        break;

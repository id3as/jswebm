...
class DataInterface{
    ...
    readVint() {
      ...
      var result = this.tempByteBuffer < 0 ? Number.MAX_SAFE_INTEGER : this.tempByteBuffer;
        // var result = this.tempByteBuffer;
        this.tempOctet = null;
  ...
  returnElement(element) {
    this.tempElementId = element.id;
    this.tempElementSize = element.size;
    this.tempElementOffset = element.offset;
  }
